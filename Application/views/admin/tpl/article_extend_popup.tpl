...
<script type="text/javascript">
    initAoc = function()
    {
        YAHOO.oxid.container1 = new YAHOO.oxid.aoc(
            ...
            '[{$oViewConf->getAjaxLink()}]cmpid=container1&container=article_extend_popup&synchoxid=[{$oxid}]'
        );
        ...
        YAHOO.oxid.container2 = new YAHOO.oxid.aoc(
            ...
            '[{$oViewConf->getAjaxLink()}]cmpid=container2&container=article_extend_popup&oxid=[{$oxid}]'
        );

        YAHOO.oxid.container1.getDropAction = function()
        {
            return 'fnc=fcAddSustainabilityToArticle';
        }
        YAHOO.oxid.container2.getDropAction = function()
        {
            return 'fnc=fcRemoveSustainabilityFromArticle';
        }
    }
...
<table width="100%">
    ...
    <tr class="edittext">
        <td align="center"><b>[{oxmultilang ident="CLINTON_SUSTAINABILITY_MAIN_ALL_TITLES"}]</b></td>
        <td align="center"><b>[{oxmultilang ident="CLINTON_SUSTAINABILITY_MAIN_ALL_TITLES_IN_ARTICLE"}]</b></td>
    </tr>
    <tr>
