    ...
    <form name="search" id="search" action="[{$oViewConf->getSelfLink()}]" method="post">
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <tr class="listitem">
                ...
                <td valign="top" class="listfilter" height="20" colspan="2">
                    <div class="r1"><div class="b1">
                            ...
                            <input class="listedit" type="text" size="60" maxlength="128" name="where[clinton_sustainability][clititle]" value="[{$where.clinton_sustainability.clititle}]">
                        </div></div>
                </td>
                [{/block}]
            </tr>
            ...
            <tr>
                ...
                <td class="listheader first" height="15" width="30" align="center"><a href="Javascript:top.oxid.admin.setSorting( document.search, 'clinton_sustainability', 'oxactive', 'asc');document.search.submit();" class="listheader">[{oxmultilang ident="GENERAL_ACTIVTITLE"}]</a></td>
            ...
            <tr id="row.[{$_cnt}]">
                ...
                <td valign="top" class="[{$listclass}]" height="15"><div class="listitemfloating"><a href="Javascript:top.oxid.admin.editThis('[{$listitem->clinton_sustainability__oxid->value}]');" class="[{$listclass}]">[{$listitem->clinton_sustainability__clititle->value}]</a></div></td>
                <td class="[{$listclass}]">
                    [{if !$listitem->isOx() && !$readonly}]
                    <a href="Javascript:top.oxid.admin.deleteThis('[{$listitem->clinton_sustainability__oxid->value}]');" class="delete" id="del.[{$_cnt}]" [{include file="help.tpl" helpid=item_delete}]></a>
                    [{/if}]
                </td>
                [{/block}]
            </tr>
